---
title: "Talks, posters, and the conference itself"
description: "What happens after acceptance: the talk, the poster session, and why hallways matter."
...
Build the deck in LaTeX so your notation matches the paper: [Beamer basics](/learn/beamer-basics/) gets you there.
...
If your project already lives in Git with GitHub sync (see [sync with GitHub](/learn/sync-with-github/)), the release is mostly a cleanup pass, not a migration.
