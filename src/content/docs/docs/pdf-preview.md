...
Hold ⌘ (Ctrl) and click any word in the PDF to jump to that word in your source, or press **⌘⇧J** (Ctrl+Shift+J) in the editor to light up the matching spot in the PDF. Full details on the [SyncTeX](/docs/synctex/) page.
