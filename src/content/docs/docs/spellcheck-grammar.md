...
There is no cloud grammar service here. The dictionaries and models ship with the app and execute locally, so drafts under embargo, unpublished results, and personal documents are never uploaded for proofreading. This is the same [local-first principle](/docs/philosophy/) as the rest of Oleafly.
