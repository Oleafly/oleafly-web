...
| `@oleafly/wysiwyg` | The constrained visual editor core: shared schema, LaTeX and Markdown parse/serialize, and the raw inline/block nodes that keep unsupported source visible instead of discarding it | none (pure) | none |
