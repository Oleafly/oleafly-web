...
Oleafly is AGPL-licensed and developed in the open at [github.com/Oleafly/Oleafly](https://github.com/Oleafly/Oleafly). The templates it ships are permissively licensed, each with its license text included. If you want to see how something works or make it better, the [Engineering section](/docs/engineering/contributing/) is the place to start.
