...
- **Insert link**: `\href{}{}`
- **Add citation**: opens the [citation lookup](/docs/citations/) (DOI, arXiv, or title)
...
- **Code intelligence** menu: go to definition, find references, rename symbol (see [Code intelligence](/docs/code-intelligence/))
