...
### Which languages does the website support?
[oleafly.com](https://oleafly.com/) is available in **18 locales**. English is the default at `/`. Other languages use a path prefix. The language switcher shows a **flag + native name** for each option.
