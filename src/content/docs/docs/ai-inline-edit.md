...
![An inline AI edit reviewed as a red/green diff](https://cdn.oleafly.com/images/screenshots/desktop/inline-ai-edit.png)

## What powers it

Inline edit uses the same active provider and model as the [chat](/docs/ai-chat/) (the panel shows which), plus your [custom instructions](/docs/ai-setup/#custom-instructions). It's a single-shot edit rather than an agent: no tools, no multi-step runs, which is what makes it instant.
