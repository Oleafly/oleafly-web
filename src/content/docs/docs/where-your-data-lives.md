...
Install Oleafly, then either pull your projects from GitHub or copy your old `~/.openleaf/projects/` folder into place. Cover colors, main-document choices, and history all travel with the folders. App-level preferences (theme, fonts, AI keys) are per-machine and take a minute to reset in [Settings](/docs/settings/).
...
Your documents, your Git history, your AI keys, and your GitHub token all live locally. The [Philosophy](/docs/philosophy/) page covers exactly which features talk to the network and what they send.
