---
title: "Auto-updates"
description: "Oleafly ships with an in-app updater (Tauri's plugin-updater). On launch it quietly checks the latest GitHub Release; if a newer version is available it opens a"
---
