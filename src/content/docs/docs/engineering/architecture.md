...
description: "Oleafly's frontend is a pnpm workspace: the app shell lives at the repo root (src/), and the engines it is built from live in packages/ as nine focused packages"
---
