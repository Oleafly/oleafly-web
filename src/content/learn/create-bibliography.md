...
A `.bib` file is a small plain-text database of everything you might cite. Each entry has a type, a key, and a set of fields, and the same file can serve every paper you write for years. A little discipline now, in how you choose types, fill fields, and name keys, saves real pain later when a journal style suddenly wants a field you never recorded.
