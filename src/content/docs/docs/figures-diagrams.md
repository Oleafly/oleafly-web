...
![The diagram composer: visual canvas, TikZ code, and live preview](https://cdn.oleafly.com/images/screenshots/desktop/diagram-composer.png)
...
If a compile fails and you have an AI provider connected, a **Fix with AI** button appears: it sends the TikZ and the compile log for a one-shot repair and recompiles. See [Draw with AI](/docs/ai-figures/#fix-with-ai-in-the-composer).
